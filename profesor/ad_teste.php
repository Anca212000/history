...
<div class="rotund">
    ...
    if(@$_POST['cont_test'])
    {
		if(isset($_POST['radio']))
		{
			...
			echo "<span><input class=\"buton\" type=\"submit\" name=\"cont_intr\" value=\"Continua\"></span>";
			echo "</form>";
		}
		else
		{
	...
	elseif(@$_POST['modif_test_lectie'])
	{
		...
		if($nume==NULL or $numeh==NULL)
		{
			...
			elseif($nume==NULL)
				echo "<i style=\"margin:4px;color:red\">Nu ati incarcat testul!</i><br>";
			elseif($numeh==NULL)
		...
		else
		{
			...
			if( ($extensie === 'swf' or $extensie ==='html' or $extensie==='htm') and ($extensie1=== 'php') )
			{
			...
			elseif($extensie !== 'swf' and $extensie !=='html' or $extensie!=='htm')
				echo "<i style=\"margin:4px;color:red\">Testul nu a fost adaugat!</i>";
			elseif($extensie1!== 'html' and $extensie1!=='htm')
