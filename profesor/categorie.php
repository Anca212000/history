...
<div class="rotund">
           ...
           if(!$k)
            ...
            elseif($k==1)
            {
				...
				if($extensie ==='php')
				{
					...
					@rename("capitole/$text/".$b,"capitole/$text/bibliografie.php");
    ...
    elseif(@$_POST['continua'])
    {
        ...
        else
        {
            ...
            while($rand=mysql_fetch_row($capitol))
            {
				...
				echo "<input type=\"hidden\" name=\"capitol\" value=\"$numec\">";
			}
            echo "<br><i style=\"margin:4px;color:red\">Nu ati selectat nimic!</i><br>";
            echo "<br><span><input class=\"buton\" type=\"submit\" name=\"continua\" value=\"Continua\"></span>";
			echo "</form>";
		}
        echo "<br><br><a href=\"acasa_prof.php\"><span><< Inapoi</span></a>";
    }
    elseif(@$_POST['continua_img'])
    {
		...
		else
		{
			...
			echo "<br><i style=\"margin:4px;color:red\">Nu ati selectat nimic!</i><br>";
			echo "<br><span><input class=\"buton\" type=\"submit\" name=\"continua_img\" value=\"Continua\"></span>";
			echo "</form>";
		}
        echo "<br><br><a href=\"acasa_prof.php\"><span><< Inapoi</span></a>";
    }
    elseif(@$_POST['continua_test'])
    {
        ...
        if($val=='ev_fin')
        {
			...
			if(mysql_num_rows($capitol)==0)
	            ...
	            echo "<br><span><input class=\"buton\" type=\"submit\" name=\"cont_test\" value=\"Continua\"></span>";
			echo "</form>";
        }
        elseif($val!='ev_fin' and $val!=NULL)
		{
			$nl=mysql_query("SELECT `nume-lect` FROM `lectii` WHERE `id-lect`='$val'");
			$nl=mysql_fetch_row($nl);
		...
		else
        {
            ...
            echo "<br><i style=\"margin:4px;color:red\">Nu ati selectat nimic!</i><br>";
            echo "<br><span><input class=\"buton\" type=\"submit\" name=\"continua_test\" value=\"Continua\"></span>";
			echo "</form>";
		}
        echo "<br><br><a href=\"acasa_prof.php\"><span><< Inapoi</span></a>";
    }
	elseif(@$_POST['modif_scap'])
	{
		if(isset($_POST['radio']))
		{
			...
			while($r=mysql_fetch_row($i))
				mysql_query("DELETE FROM `raspunsuri` WHERE `id-intreb`='$r[0]'");
		...
		else
		{
            ...
            echo "<br><span><input class=\"buton\" type=\"submit\" name=\"continua_scap\" value=\"Continua\"></span>";
			echo "</form>";
		}
		echo "<br><br><a href=\"acasa_prof.php\"><span><< Inapoi</span></a>";
	}
	elseif(@$_POST['modif_slec'])
	{
		...
		else
		{
            ...
            echo "<br><span><input class=\"buton\" type=\"submit\" name=\"continua_slec\" value=\"Continua\"></span>";
			echo "</form>";
		}
		echo "<br><br><a href=\"acasa_prof.php\"><span><< Inapoi</span></a>";
	}
	elseif(@$_POST['modif_simg'])
	{
		...
		if($val=='im_cap')
		{
			...
			else
			{
				...
				echo "<br><br><span><input class=\"buton\" type=\"submit\" name=\"sterg_img1\" value=\"Sterge\"></span>";
				echo "</form>";
			}
		}
		elseif($val=='im_lect')
		{
			...
			else
			{
				...
				echo "<br><span><input class=\"buton\" type=\"submit\" name=\"sterg_img2\" value=\"Sterge\"></span>";
				echo "</form>";
			}
		}
		else
		{
			...
			echo "<br><i style=\"margin:4px;color:red\">Nu ati selectat nimic!</i><br>";
			echo "<br><span><input class=\"buton\" type=\"submit\" name=\"modif_simg\" value=\"Continua\"></span>";
			echo "</form>";
		}
		echo "<br><br><a href=\"acasa_prof.php\"><span><< Inapoi</span></a>";
	}
	elseif(@$_POST['modif_stest'])
	{
        ...
        elseif($val!='ev_fin' and $val!=NULL)
		{
			...
			echo "<i style=\"margin:4px;color:red\">Testul s-a sters!</i>";
        }
		else
        {
			echo "<form action=\"categorie.php\" method=\"post\">";
            ...
            echo "<br>Teste de la o lectie specifica unui capitol:<br>";
            $capitol=mysql_query("SELECT * FROM capitole");
            if(mysql_num_rows($capitol)==0)
                echo "<i style=\"margin:4px;color:red\">Imi pare rau, nu aveti nici un capitol.</i><br>";
            else
            ...
            echo "<br><i style=\"margin:4px;color:red\">Nu ati selectat nimic!</i><br>";
            echo "<br><span><input class=\"buton\" type=\"submit\" name=\"modif_stest\" value=\"Continua\"></span>";
			echo "</form>";
		}
        echo "<br><br><a href=\"acasa_prof.php\"><span><< Inapoi</span></a>";
	}
